...
export default function PostCard({ title, body, id }) {
  ...
  return (
    <>
      ...
      <div className="my-4 shadow-xl bg-slate-200 dark:bg-slate-900 w-[calc(100vw-73px)] mx-auto p-5 rounded-xl">
        <h1 className="font-extrabold text-[#222328] dark:text-white text-xl">
          {title}
        </h1>
